...
<body class="linear-gradient">
    ...
    <div class="container">
        <div class="m-4 block-background-profil text-center">
            <h2>Mon profil</h2>
            ...
            <button type="button" id="update_button" class="submit-button border-0 font-weight-bold">Modifier mon profil</button>
            <button type="button" id="update_id_button" class="submit-button border-0 font-weight-bold">Modifier mon mot de passe</button>
            <button type="button" id="delete_button" class="submit-button border-0 font-weight-bold">Supprimer mon compte</button>
        </div>
